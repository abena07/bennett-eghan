export const meta = {
  ...
  date: "june 20, 2024",
  image: "https://og.tailgraph.com/og?fontFamily=Inter&title=on%20starting%20oss%20contribution&titleTailwind=text-white%20text-5xl%20font-bold&titleFontFamily=Inter&text=bennett-eghan.com&textTailwind=text-gray-400%20text-2xl%20mt-4&textFontFamily=Inter&bgTailwind=bg-gray-900&footer=abena&footerTailwind=text-gray-400%20text-xl",
  tags: ["technical"] 
}
