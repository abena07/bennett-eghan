export const meta = {
  ...
  description: "breaking down recursion step by step",
  date: "july 14, 2025",
  image: "https://og.tailgraph.com/og?fontFamily=Inter&title=my%20approach%20to%20solving%20recursive%20problems&titleTailwind=text-white%20text-5xl%20font-bold&titleFontFamily=Inter&text=bennett-eghan.com&textTailwind=text-gray-400%20text-2xl%20mt-4&textFontFamily=Inter&bgTailwind=bg-gray-900&footer=abena&footerTailwind=text-gray-400%20text-xl",
  tags: ["technical"] 
}
